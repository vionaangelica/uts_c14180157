...
export class FotoService {
  ...
  public async tambahFoto(judul){
    ...
    const fileFoto = await this.simpanFoto(Foto, judul);
  ...
  public async simpanFoto(foto : CameraPhoto, judul){
      const base64Data = await this.readAsBase64(foto);
      const namaFile = judul;
